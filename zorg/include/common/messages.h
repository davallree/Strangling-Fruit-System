...
inline constexpr char kSetHandStateMethod[] = "setHandState";
...
inline constexpr char kSetLedsEnabledMethod[] = "setLedsEnabled";
inline constexpr char kEnabledParam[] = "enabled";
